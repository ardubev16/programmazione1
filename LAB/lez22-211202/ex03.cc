...
void ricerca(albero radice, int numero);
...
void ricerca(albero radice, int numero) {
    ...
    else if (radice->value == numero)
        cout << "trovato" << endl;
    else if (radice->value < numero) {
        cout << radice->value << ", destra" << endl;
        ricerca(radice->right, numero);
    } else if (radice->value > numero) {
        cout << radice->value << ", sinistra" << endl;
        ricerca(radice->left, numero);
    }
}
